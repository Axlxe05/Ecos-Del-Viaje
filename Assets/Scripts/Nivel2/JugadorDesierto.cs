...
public class JugadorDesierto : MonoBehaviour
{
    ...
    private Vector3 firstPersonOffset = new Vector3(0, -0.25f, 0); // Offset para primera persona
    private Vector3 thirdPersonOffset = new Vector3(0, 0.5f, -5.0f); // Offset para tercera persona
