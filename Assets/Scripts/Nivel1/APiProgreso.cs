...
public class APiProgreso : MonoBehaviour
{
    private string urlGuardarProgreso = "http://13.219.131.239/APIRestProgresoUnity/crud/insertar.php";

    public int jugadorId; // Este debe venir del login (usuario que ha iniciado sesión)
    public string mapaActual = "bosque"; // Nombre del nivel o mapa
